...
//
//     final postListingModel = postListingModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

PostListingModel postListingModelFromJson(String str) => PostListingModel.fromJson(json.decode(str));

String postListingModelToJson(PostListingModel data) => json.encode(data.toJson());
...
class PostListingModel {
  ...
  factory PostListingModel.fromJson(Map<String, dynamic> json) => PostListingModel(
    status: json["status"],
...
class PostDataArray {
  ...
  final List<dynamic> mentionUserData;
  ...
  final List<HashtagList> hashtagList;
  final int tagCount;
  ...
  factory PostDataArray.fromJson(Map<String, dynamic> json) => PostDataArray(
    ...
    mentionUserData: List<dynamic>.from(json["mention_user_data"].map((x) => x)),
    ...
    hashtagList: List<HashtagList>.from(json["hashtag_list"].map((x) => HashtagList.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "mention_user_data": List<dynamic>.from(mentionUserData.map((x) => x)),
    ...
    "hashtag_list": List<dynamic>.from(hashtagList.map((x) => x.toJson())),
    "tag_count": tagCount,
  };
}
...
class HashtagList {
  ...
  factory HashtagList.fromJson(Map<String, dynamic> json) => HashtagList(
